...
export default {
  ...
  watch: {
    ...
    currentSong(newSong, oldSong) {
      ...
      if (!newSong.url) {
        ...
        getVkey(newSong.mid).then(vkey => {
          newSong.url = `http://dl.stream.qqmusic.qq.com/C400${
            newSong.mid
          }.m4a?vkey=${vkey}&guid=7631401125&uin=1103052133&fromtag=66`;
  ...
  methods: {
    ...
    // Lyric对象里当前歌词行数变化时回调函数，能访问到对象里的数据
    ...
    // el:触发enter事件的元素  done：回调函数，enter完成后触发afterEnter
    enter(el, done) {
